...
// helper de formato para Home
const formatTemp = (valueInCelsius) => formatTempValue(valueInCelsius, unit.value)
          ...
          <div class="home-card h-100" style="display: flex; flex-direction: column; gap: 10px">
            ...
            <div class="d-flex align-items-baseline gap-2">
              <div style="font-size: 2.25rem; font-weight: 700; line-height: 1">
                {{ formatTemp(capital.temp) }}°
              </div>
              <div class="home-muted small">{{ tempSuffix }} · {{ capital.description }}</div>
            </div>
